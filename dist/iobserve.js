(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.IObserve = factory());
  ...
  var queryElements = function queryElements(settings) {
    return settings.container.querySelectorAll(settings.elements);
  };
  ...
  var retryIObserve = function retryIObserve(settings, instance) {
  ...
  IObserve.load = function (element, customSettings) {
    var settings = getExtendedSettings(customSettings);
    load(element, settings);
  };

  IObserve.resetStatus = function (element) {
    resetStatus(element);
